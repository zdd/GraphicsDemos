...
INT WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR szCmdLine, int iCmdShow)
{
	...
	hProgMan = FindWindow(L"Progman", L"Program Manager");
	if(hProgMan != NULL)
	{
		hShell = FindWindowEx(hProgMan, 0, L"SHELLDLL_DefView", NULL);
	}
	else
	{
		hProgMan = FindWindow(L"DesktopBackgroundClass", NULL);
		if(hProgMan != NULL)
			hShell = FindWindowEx(hProgMan, 0, L"DeskFolder", NULL);
	}
	...
	hWnd = CreateWindowEx( 
		...
		L"Triangle", 
		L"Window Title",
		WS_CHILDWINDOW | WS_OVERLAPPED | WS_CLIPCHILDREN, 
		0,
		0,
		640,
		480, 
