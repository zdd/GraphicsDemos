...
{
	GLuint vertex_shader = create_shader("fragmentshader_circle.vs", GL_VERTEX_SHADER);
	if (vertex_shader == 0)
		return 0;

	GLuint fragment_shader = create_shader("fragmentshader_circle.fs", GL_FRAGMENT_SHADER);
	...
	uniform_name = "timedelta";
	uniform_timedelta = glGetUniformLocation(program, uniform_name);
...
void onIdle()
{
	...
	glUniform1f(uniform_timedelta, angle);
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("Fragment shader - circle");
